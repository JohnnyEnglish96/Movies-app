...
const PostImage = (prop) => {
  ...
  return <Image src={`${baseImgUrl}${poster_path}`} width={200} />;
};
...
export default class CardItem extends Component {
  render() {
    ...
    const { original_title, overview, poster_path, release_date } = searchResult;
      ...
      >
        <Space className="space">
          ...
          <div className="content">
            ...
            <Text className="text">{overview ? splicedOverview(overview, original_title) : NO_OVERVIEW_TEXT}</Text>
          </div>
        </Space>
      </Card>
    );
